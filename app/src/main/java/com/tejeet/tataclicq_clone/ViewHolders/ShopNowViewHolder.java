...
public class ShopNowViewHolder extends RecyclerView.ViewHolder {

    private static final String TAG = "tag";
    private ImageView mImageTitle;
    private CategoryClickListner categoryClickListner;

    public ShopNowViewHolder(@NonNull View itemView, CategoryClickListner categoryClickListner) {
        super(itemView);

        mImageTitle = itemView.findViewById(R.id.ivshopnowImages);
